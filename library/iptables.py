...
options:
  ...
  uid_owner:
    description:
      - Specifies the UID or username to use in match by owner rule. When the
        "!" argument is prepended it inverts the rule to apply instead to all
        users except the one specified.
    version_added: "2.1"
  reject_with:
    description:
